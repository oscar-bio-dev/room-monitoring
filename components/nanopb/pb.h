...
#define PB_FIELDINFO_2(tag, type, data_offset, data_size, size_offset, array_size)                                     \
    (1 | (((uint32_t) (tag) << 2) & 0xFF) | ((type) << 8) | (((uint32_t) (array_size) &0xFFF) << 16) |                 \
...
#define PB_FIELDINFO_4(tag, type, data_offset, data_size, size_offset, array_size)                                     \
    (2 | (((uint32_t) (tag) << 2) & 0xFF) | ((type) << 8) | (((uint32_t) (array_size) &0xFFFF) << 16)),                \
        ((uint32_t) (int_least8_t) (size_offset) | (((uint32_t) (tag) << 2) & 0xFFFFFF00)), (data_offset),             \
        (data_size),

#define PB_FIELDINFO_8(tag, type, data_offset, data_size, size_offset, array_size)                                     \
    (3 | (((uint32_t) (tag) << 2) & 0xFF) | ((type) << 8)),                                                            \
        ((uint32_t) (int_least8_t) (size_offset) | (((uint32_t) (tag) << 2) & 0xFFFFFF00)), (data_offset),             \
        (data_size), (array_size), 0, 0, 0,
